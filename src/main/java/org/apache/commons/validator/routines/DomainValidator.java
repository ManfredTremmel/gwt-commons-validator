...
public class DomainValidator implements Serializable {
    ...
    // Max 63 characters
    private static final String TOP_LABEL_REGEX = "[a-zA-Z]([a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?";
    ...
    private static final String DOMAIN_NAME_REGEX = "(" + TOP_LABEL_REGEX + ")\\.{0,1}$";
    private static final String COMPLETE_DOMAIN_REGEX = "^(" + DOMAIN_LABEL_REGEX + "\\.)+" + DOMAIN_NAME_REGEX;
    ...
    final boolean isValidDomainSyntax(String domain) {
        ...
        String[] groups = domainRegex.match(domain);
        return (groups != null && groups.length > 0 && completeDomainRegex.match(domain) != null)
    ...
    private static final String toASCII(String line) throws IllegalArgumentException {
        ...
        try {
        	return Punycode.encodeDomain(line.toLowerCase(Locale.ENGLISH));
