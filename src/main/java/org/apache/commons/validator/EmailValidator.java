...
public class EmailValidator {
    ...
    private static final RegExp USER_PATTERN = RegExp.compile("^\\s*" + WORD + "(\\." + WORD + ")*$");
    private static final RegExp DOMAIN_PATTERN = RegExp.compile("^" + ATOM + "(\\." + ATOM + ")*\\s*$");
    ...
    protected boolean isValidSymbolicDomain(String domain) {
        ...
        while (match) {
            ...
            if (match) {
                domainSegment[i] = atomMatcher.getGroup(1);
    ...
    */
    protected String stripComments(String emailStr)  {
     ...
     RegExp commentMatcher = RegExp.compile(commentPat);
     
     while (commentMatcher.exec(result) != null) {
